...
export const routes: Routes = [
    ...
    {path: '' , component: BlankComponent, canActivate:[authGuard] , title: 'blank', children : [
            ...
            {path: 'cart' , loadComponent: ()=> import('./pages/carts/carts.component').then( (c)=>c.CartsComponent ) , title: 'cart'},
            ...
            {path: 'cash/:id' , loadComponent: ()=> import('./pages/cash/cash.component').then((c)=>c.CashComponent) , title: 'Cash'},
            {path: 'details/:id' , loadComponent: ()=> import('./pages/details/details.component').then((c)=>c.DetailsComponent) , title: 'Product Details'},
    ]},
